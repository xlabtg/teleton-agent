...
| --------- | -------- | ---------------- | -------------------------------------------------------------------------------------- | ------------ | ------- |
| WORK7-001 | High     | data-integrity   | [WORK7-001](issues/WORK7-001-fts5-delete-triggers-plain-delete.md)                      | _pending_    | Drafted |
| WORK7-002 | High     | data-integrity   | [WORK7-002](issues/WORK7-002-tool-index-insert-or-replace-rowid-churn.md)               | _pending_    | Drafted |
| WORK7-003 | High     | financial-safety | [WORK7-003](issues/WORK7-003-policy-engine-daily-ton-budget-never-enforced.md)          | _pending_    | Drafted |
| WORK7-004 | High     | financial-safety | [WORK7-004](issues/WORK7-004-tx-lock-releases-mutex-on-timeout.md)                      | _pending_    | Drafted |
| WORK7-005 | High     | reliability      | [WORK7-005](issues/WORK7-005-markdown-placeholder-dollar-replacement-corruption.md)     | _pending_    | Drafted |
| WORK7-006 | Medium   | security         | [WORK7-006](issues/WORK7-006-integration-provider-read-ssrf.md)                         | _pending_    | Drafted |
| WORK7-007 | Medium   | data-integrity   | [WORK7-007](issues/WORK7-007-hybrid-search-vector-only-score-unweighted.md)             | _pending_    | Drafted |
| WORK7-008 | Medium   | data-integrity   | [WORK7-008](issues/WORK7-008-stale-message-vector-on-failed-reembed.md)                 | _pending_    | Drafted |
| WORK7-009 | Medium   | reliability      | [WORK7-009](issues/WORK7-009-tool-result-truncator-cap-not-guaranteed.md)               | _pending_    | Drafted |
| WORK7-010 | Medium   | financial-safety | [WORK7-010](issues/WORK7-010-jetton-send-zero-decimals.md)                              | _pending_    | Drafted |
| WORK7-011 | Medium   | reliability      | [WORK7-011](issues/WORK7-011-workflow-event-webhook-bypass-dedup.md)                    | _pending_    | Drafted |
| WORK7-012 | Medium   | reliability      | [WORK7-012](issues/WORK7-012-managed-agent-inbox-unbounded.md)                          | _pending_    | Drafted |
| WORK7-013 | Medium   | reliability      | [WORK7-013](issues/WORK7-013-managed-agent-restart-count-never-reset.md)                | _pending_    | Drafted |
| WORK7-014 | Medium   | reliability      | [WORK7-014](issues/WORK7-014-lifecycle-sse-listener-leak.md)                            | _pending_    | Drafted |
| WORK7-015 | Medium   | security         | [WORK7-015](issues/WORK7-015-workspace-write-world-readable-files.md)                   | _pending_    | Drafted |
| WORK7-016 | Medium   | reliability      | [WORK7-016](issues/WORK7-016-config-save-clobbers-unsaved-edits.md)                     | _pending_    | Drafted |
| WORK7-017 | Medium   | reliability      | [WORK7-017](issues/WORK7-017-security-approval-params-json-parse-render-crash.md)       | _pending_    | Drafted |
| WORK7-018 | Medium   | reliability      | [WORK7-018](issues/WORK7-018-bot-bridge-splits-html-mid-tag.md)                         | _pending_    | Drafted |
| WORK7-019 | Low      | reliability      | [WORK7-019](issues/WORK7-019-ui-mutations-swallow-promise-rejections.md)                | _pending_    | Drafted |
| WORK7-020 | Low      | reliability      | [WORK7-020](issues/WORK7-020-pipelines-poll-resets-selected-run.md)                     | _pending_    | Drafted |
| WORK7-021 | Low      | reliability      | [WORK7-021](issues/WORK7-021-strip-markup-tags-over-consumes-text.md)                   | _pending_    | Drafted |
| WORK7-022 | Medium   | security         | [WORK7-022](issues/WORK7-022-gocoon-data-dir-not-0700.md)                               | _pending_    | Drafted |
